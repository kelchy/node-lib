...
describe('common functions tests', () => {
  ...
  test('isAlive should return boolean', async () => {
    ...
    // Test with invalid hostname that should fail
    const invalidHost = await common.isAlive('invalid-hostname-that-does-not-exist-12345', 80)
    expect(invalidHost).toEqual(false)
  })
